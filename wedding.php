...
<body>
	...
	<div align="center" class="banner">
		<a id="top"></a>
		<div><h3 class="title">明 道 人 婚 紗</h3></div>
	...
	<div class="content">
		...
		<div class = "form" align="center">
			...
			<form action="wedding_exe.php" method="post">
			...
			<table cellpadding="15">
				...
				<tr>
					<td>人力支援</td>
					<td style="max-width:60vw;">
						<span class="option"><input type="radio" name="help" value="need"> 需校友會派職員
							
							<input type="number" name="helper" style="width:50px;">人，工友<input type="number" name="worker" style="width:50px;">人協助
						
						
						</span><Br>
						<span class="option"><input type="radio" name="help" value="false" checked> 不需派員協助</span>
					</td>
				</tr>
				
				<tr>
					<td colspan="2" align="center"><h2>明道中學校友返校拍攝婚紗小故事</h2></td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<input type="number" name="year_m" min="50" max="120">年畢業<br>
						<span class="option"><input type="text" name="department_m">科</span>
						<span class="option"><input type="text" name="class_m">班</span>
				...
				<tr>
					...
					<td>
						...
						<input type="number" name="year_f" min="50" max="120">年畢業<br>
						<span class="option"><input type="text" name="department_f">科</span>
						<span class="option"><input type="text" name="class_f">班</span>
				...
				<tr>
					<td>小故事分享</td>
					<td>
						<textarea name="story" style="width:45vw;height:10vh;"></textarea>
					</td>
				</tr>
			</table>
