...
<div class="content1">
  <?php
    ...
    $sql = 'SELECT * FROM `'.$_GET['year'].'` WHERE `class` = "'.$_GET['class'].'"';
    $run = mysqli_query($con,$sql);
    $row = mysqli_fetch_assoc($run);
    ?>


    <object data="<?php echo $row['file']; ?>#zoom=80&scrollbar=0&toolbar=0&navpanes=0" type="application/pdf" width="80%" height="800px">
        <p>
            It appears you don't have a PDF plugin for this browser.
        </p>
    </object>

    <p><input type="button" button style="width:150px; height: 70px; margin: 40px; background-color: transparent; border-radius: 25px;" value="Go back!" onclick="history.back()"></p>
